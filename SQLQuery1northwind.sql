...
select title from employees where first_name = 'Nancy' 
3. Get the price of an order (by multiplying unit price by quantity) from Order Details.

select unit_price * quantity as price  from[order_details]
...
select product_name from products where unit_price > 90
...
select unit_price from[order_details] where unit_price between  10 and 40 
13. Display the company name where Region is NULL in Customer Table.
select company_name from customers where region is null
14. Write a query to list employees who live in London, Seattle or Redmond
select first_name ,last_name from employees where city in('london','Seattle','Redmond')
15. Write a query to list employees whose address contains 3 numbers in its start.\
select first_name ,last_name, address from employees where Address like'%[1-3]%'
16. Write a query to list employees whose address does not contain Rd.
select first_name ,last_name, address from employees where Address not like'%rd%'

17. Write a query to list all those employees whose TitleofCourtesy does not starts with M.
select * from employees where title_of_courtesy not like 'M%' 
...
select product_name from products where unit_price between 10 and 50 and quantity_per_unit like '%bottles%'
20. List all products where UnitPrice is not in 10,12,15,17 or 19.
select product_name, unit_price from products where unit_price in (10,12,15,17,19)
